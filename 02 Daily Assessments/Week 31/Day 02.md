...
type: assessment
schema_version: 1
id: assessment-w31-d02-terraform-state-modules-and-secrets
date: null
week: 31
...
# Week 31 / Day 02 Micro-Assessment
...
1. Explain the key invariant, mechanism, or trade-off in **Provision a bounded AWS resource set in code or safe sandbox** without relying on tool/framework vocabulary alone.
2. What concrete evidence would validate or falsify your conclusion about **Provision a bounded AWS resource set in code or safe sandbox** in a production-oriented backend?
