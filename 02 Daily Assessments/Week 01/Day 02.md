...
type: assessment
schema_version: 1
id: assessment-w01-d02-php-types-and-safe-git
date: null
week: 1
...
# Week 01 / Day 02 Micro-Assessment

## Instructions snapshot

- Timebox: **20 minutes**.
- Mode: **SOLO**.
- Do not use an LLM, coding agent, answer search, or an existing solution.
- Record your response before feedback.
- If you request help, explicitly mark the scored attempt `abandoned` first.

## Prompts

1. Design a two-file experiment distinguishing strict/coercive scalar calls.
2. After running it, explain any mismatch between expectation and evidence.
...
Grade only after submission using `docs/assessments.md`.
