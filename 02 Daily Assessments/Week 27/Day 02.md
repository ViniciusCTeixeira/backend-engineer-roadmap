...
type: assessment
schema_version: 1
id: assessment-w27-d02-aws-runtime-rds-elasticache-ecs-alb
date: null
week: 27
...
# Week 27 / Day 02 Micro-Assessment
...
1. Explain the key invariant, mechanism, or trade-off in **Design ALB listeners/target groups/health checks** without relying on tool/framework vocabulary alone.
2. What concrete evidence would validate or falsify your conclusion about **Design ALB listeners/target groups/health checks** in a production-oriented backend?
