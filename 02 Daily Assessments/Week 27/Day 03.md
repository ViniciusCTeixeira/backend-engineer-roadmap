...
type: assessment
schema_version: 1
id: assessment-w27-d03-aws-runtime-rds-elasticache-ecs-alb
date: null
week: 27
...
# Week 27 / Day 03 Micro-Assessment
...
1. Explain the key invariant, mechanism, or trade-off in **Map MySQL guarantees to managed RDS choices** without relying on tool/framework vocabulary alone.
2. What concrete evidence would validate or falsify your conclusion about **Map MySQL guarantees to managed RDS choices** in a production-oriented backend?
