...
type: assessment
schema_version: 1
id: assessment-w27-d04-aws-runtime-rds-elasticache-ecs-alb
date: null
week: 27
...
# Week 27 / Day 04 Micro-Assessment
...
1. Explain the key invariant, mechanism, or trade-off in **Map Redis cache semantics to ElastiCache** without relying on tool/framework vocabulary alone.
2. What concrete evidence would validate or falsify your conclusion about **Map Redis cache semantics to ElastiCache** in a production-oriented backend?
