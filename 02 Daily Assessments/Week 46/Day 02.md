...
type: assessment
schema_version: 1
id: assessment-w46-d02-agents-workflows-and-mcp
date: null
week: 46
...
# Week 46 / Day 02 Micro-Assessment
...
1. Explain the key invariant, mechanism, or trade-off in **Design context/acceptance criteria that reduce ambiguity** without relying on tool/framework vocabulary alone.
2. What concrete evidence would validate or falsify your conclusion about **Design context/acceptance criteria that reduce ambiguity** in a production-oriented backend?
