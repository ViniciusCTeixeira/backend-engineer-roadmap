...
type: assessment
schema_version: 1
id: assessment-w46-d01-agents-workflows-and-mcp
date: null
week: 46
...
# Week 46 / Day 01 Micro-Assessment
...
1. Explain the key invariant, mechanism, or trade-off in **Decompose a repo task into bounded agent work** without relying on tool/framework vocabulary alone.
2. What concrete evidence would validate or falsify your conclusion about **Decompose a repo task into bounded agent work** in a production-oriented backend?
