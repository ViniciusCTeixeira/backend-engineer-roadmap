...
type: assessment
schema_version: 1
id: assessment-w46-d04-agents-workflows-and-mcp
date: null
week: 46
...
# Week 46 / Day 04 Micro-Assessment
...
1. Explain the key invariant, mechanism, or trade-off in **Build or configure one bounded MCP capability without broad permissions** without relying on tool/framework vocabulary alone.
2. What concrete evidence would validate or falsify your conclusion about **Build or configure one bounded MCP capability without broad permissions** in a production-oriented backend?
