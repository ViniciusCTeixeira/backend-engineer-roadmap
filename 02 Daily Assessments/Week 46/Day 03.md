...
type: assessment
schema_version: 1
id: assessment-w46-d03-agents-workflows-and-mcp
date: null
week: 46
...
# Week 46 / Day 03 Micro-Assessment
...
1. Explain the key invariant, mechanism, or trade-off in **Map MCP client/server/tool/resource trust boundaries** without relying on tool/framework vocabulary alone.
2. What concrete evidence would validate or falsify your conclusion about **Map MCP client/server/tool/resource trust boundaries** in a production-oriented backend?
