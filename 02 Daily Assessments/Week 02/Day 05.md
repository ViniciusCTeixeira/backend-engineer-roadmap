...
type: assessment
schema_version: 1
id: assessment-w02-d05-oop-composer-and-boundaries
date: null
week: 2
...
# Week 02 / Day 05 Micro-Assessment
...
1. Write a bounded agent task: goal, scope, invariants, validation, non-goals.
2. What output would make you stop the agent for scope creep?
