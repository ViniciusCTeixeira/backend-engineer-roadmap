...
type: assessment
schema_version: 1
id: assessment-w02-d03-oop-composer-and-boundaries
date: null
week: 2
...
# Week 02 / Day 03 Micro-Assessment
...
1. Explain composer install vs update when composer.lock is committed.
2. Write one version constraint and explain what it permits.
