...
type: assessment
schema_version: 1
id: assessment-w26-d04-phase-gate-two-modern-backend-and-cloud
date: null
week: 26
...
# Week 26 / Day 04 Micro-Assessment
...
1. Explain the key invariant, mechanism, or trade-off in **Closed AWS IAM/VPC design case** without relying on tool/framework vocabulary alone.
2. Identify the most important prerequisite dependency tested by **Closed AWS IAM/VPC design case** and the critical evidence/floor that would trigger remediation.
