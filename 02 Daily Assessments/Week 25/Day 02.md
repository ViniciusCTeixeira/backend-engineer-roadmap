...
type: assessment
schema_version: 1
id: assessment-w25-d02-aws-foundations-iam-vpc-and-edge
date: null
week: 25
...
# Week 25 / Day 02 Micro-Assessment
...
1. Explain the key invariant, mechanism, or trade-off in **Design VPC/subnet/route/security-group boundaries** without relying on tool/framework vocabulary alone.
2. What concrete evidence would validate or falsify your conclusion about **Design VPC/subnet/route/security-group boundaries** in a production-oriented backend?
