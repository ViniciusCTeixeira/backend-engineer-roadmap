...
type: assessment
schema_version: 1
id: assessment-w25-d03-aws-foundations-iam-vpc-and-edge
date: null
week: 25
...
# Week 25 / Day 03 Micro-Assessment
...
1. Explain the key invariant, mechanism, or trade-off in **Use AWS CLI read-only and verify identity/context** without relying on tool/framework vocabulary alone.
2. What concrete evidence would validate or falsify your conclusion about **Use AWS CLI read-only and verify identity/context** in a production-oriented backend?
