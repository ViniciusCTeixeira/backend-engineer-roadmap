...
type: assessment
schema_version: 1
id: assessment-w25-d05-aws-foundations-iam-vpc-and-edge
date: null
week: 25
...
# Week 25 / Day 05 Micro-Assessment
...
1. Explain the key invariant, mechanism, or trade-off in **Draw the complete public-to-private request path and threats** without relying on tool/framework vocabulary alone.
2. What concrete evidence would validate or falsify your conclusion about **Draw the complete public-to-private request path and threats** in a production-oriented backend?
