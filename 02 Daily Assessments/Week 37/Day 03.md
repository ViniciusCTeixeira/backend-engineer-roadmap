...
type: assessment
schema_version: 1
id: assessment-w37-d03-llm-tool-calling-and-bounded-actions
date: null
week: 37
...
# Week 37 / Day 03 Micro-Assessment
...
1. Explain the key invariant, mechanism, or trade-off in **Separate model proposal from application execution** without relying on tool/framework vocabulary alone.
2. What concrete evidence would validate or falsify your conclusion about **Separate model proposal from application execution** in a production-oriented backend?
