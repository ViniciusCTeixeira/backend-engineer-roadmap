...
type: assessment
schema_version: 1
id: assessment-w37-d02-llm-tool-calling-and-bounded-actions
date: null
week: 37
...
# Week 37 / Day 02 Micro-Assessment
...
1. Explain the key invariant, mechanism, or trade-off in **Validate tool arguments and reject unauthorized resource access** without relying on tool/framework vocabulary alone.
2. What concrete evidence would validate or falsify your conclusion about **Validate tool arguments and reject unauthorized resource access** in a production-oriented backend?
