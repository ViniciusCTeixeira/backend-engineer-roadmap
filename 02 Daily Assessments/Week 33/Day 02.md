...
type: assessment
schema_version: 1
id: assessment-w33-d02-capacity-scalability-and-load-models
date: null
week: 33
...
# Week 33 / Day 02 Micro-Assessment
...
1. Explain the key invariant, mechanism, or trade-off in **Identify CPU/memory/DB/cache/network bottleneck hypotheses** without relying on tool/framework vocabulary alone.
2. What concrete evidence would validate or falsify your conclusion about **Identify CPU/memory/DB/cache/network bottleneck hypotheses** in a production-oriented backend?
