...
type: assessment
schema_version: 1
id: assessment-w23-d05-nginx-php-fpm-production-path
date: null
week: 23
...
# Week 23 / Day 05 Micro-Assessment
...
1. Explain the key invariant, mechanism, or trade-off in **Diagnose a broken local-production stack evidence-first** without relying on tool/framework vocabulary alone.
2. What concrete evidence would validate or falsify your conclusion about **Diagnose a broken local-production stack evidence-first** in a production-oriented backend?
