...
type: assessment
schema_version: 1
id: assessment-w23-d03-nginx-php-fpm-production-path
date: null
week: 23
...
# Week 23 / Day 03 Micro-Assessment
...
1. Explain the key invariant, mechanism, or trade-off in **Reason about timeouts/body limits and upstream failure** without relying on tool/framework vocabulary alone.
2. What concrete evidence would validate or falsify your conclusion about **Reason about timeouts/body limits and upstream failure** in a production-oriented backend?
