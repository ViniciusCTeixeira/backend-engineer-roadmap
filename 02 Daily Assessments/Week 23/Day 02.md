...
type: assessment
schema_version: 1
id: assessment-w23-d02-nginx-php-fpm-production-path
date: null
week: 23
...
# Week 23 / Day 02 Micro-Assessment
...
1. Explain the key invariant, mechanism, or trade-off in **Configure document root/front controller/FastCGI safely** without relying on tool/framework vocabulary alone.
2. What concrete evidence would validate or falsify your conclusion about **Configure document root/front controller/FastCGI safely** in a production-oriented backend?
