...
type: assessment
schema_version: 1
id: assessment-w23-d04-nginx-php-fpm-production-path
date: null
week: 23
...
# Week 23 / Day 04 Micro-Assessment
...
1. Explain the key invariant, mechanism, or trade-off in **Correlate access/error/FPM logs** without relying on tool/framework vocabulary alone.
2. What concrete evidence would validate or falsify your conclusion about **Correlate access/error/FPM logs** in a production-oriented backend?
