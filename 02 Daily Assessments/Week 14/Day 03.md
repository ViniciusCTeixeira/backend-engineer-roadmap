...
type: assessment
schema_version: 1
id: assessment-w14-d03-http-semantics-idempotency-and-api-contracts
date: null
week: 14
...
# Week 14 / Day 03 Micro-Assessment
...
1. Why is HTTP caching not the same as Redis cache-aside?
2. How can a cookie identify server-side session state?
