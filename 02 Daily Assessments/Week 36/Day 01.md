...
# Week 36 / Day 01 — V1.1 Micro-Assessment
...
1. What can JSON Schema validate that it cannot prove?
2. Which inputs should never be sent to the model?
