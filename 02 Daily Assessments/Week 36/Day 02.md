...
# Week 36 / Day 02 — V1.1 Micro-Assessment
...
1. Why should provider SDK calls be behind an application boundary?
2. What happens when valid structured output is semantically wrong?
