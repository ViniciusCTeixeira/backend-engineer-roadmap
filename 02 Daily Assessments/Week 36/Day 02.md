...
type: assessment
schema_version: 1
id: assessment-w36-d02-llm-api-structured-output-and-validation
date: null
week: 36
...
# Week 36 / Day 02 Micro-Assessment
...
1. Explain the key invariant, mechanism, or trade-off in **Design a typed schema for a backend AI task** without relying on tool/framework vocabulary alone.
2. What concrete evidence would validate or falsify your conclusion about **Design a typed schema for a backend AI task** in a production-oriented backend?
