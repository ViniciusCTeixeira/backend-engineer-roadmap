...
type: assessment
schema_version: 1
id: assessment-w40-d02-ai-evals-security-and-production-quality
date: null
week: 40
...
# Week 40 / Day 02 Micro-Assessment
...
1. Explain the key invariant, mechanism, or trade-off in **Build a small versioned eval dataset with edge cases** without relying on tool/framework vocabulary alone.
2. What concrete evidence would validate or falsify your conclusion about **Build a small versioned eval dataset with edge cases** in a production-oriented backend?
