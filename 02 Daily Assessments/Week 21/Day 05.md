...
type: assessment
schema_version: 1
id: assessment-w21-d05-pragmatic-backend-architecture
date: null
week: 21
...
# Week 21 / Day 05 Micro-Assessment
...
1. Explain the key invariant, mechanism, or trade-off in **Write and defend an ADR with an agent as critic** without relying on tool/framework vocabulary alone.
2. What concrete evidence would validate or falsify your conclusion about **Write and defend an ADR with an agent as critic** in a production-oriented backend?
