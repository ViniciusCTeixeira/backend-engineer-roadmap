...
type: assessment
schema_version: 1
id: assessment-w21-d02-pragmatic-backend-architecture
date: null
week: 21
...
# Week 21 / Day 02 Micro-Assessment
...
1. Explain the key invariant, mechanism, or trade-off in **Use DTO/value objects where invariants justify them** without relying on tool/framework vocabulary alone.
2. What concrete evidence would validate or falsify your conclusion about **Use DTO/value objects where invariants justify them** in a production-oriented backend?
