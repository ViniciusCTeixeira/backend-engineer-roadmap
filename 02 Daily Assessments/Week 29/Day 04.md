...
type: assessment
schema_version: 1
id: assessment-w29-d04-delivery-pipelines-quality-and-security-scanning
date: null
week: 29
...
# Week 29 / Day 04 Micro-Assessment
...
1. Explain the key invariant, mechanism, or trade-off in **Run Trivy exposure against a disposable image/repository** without relying on tool/framework vocabulary alone.
2. What concrete evidence would validate or falsify your conclusion about **Run Trivy exposure against a disposable image/repository** in a production-oriented backend?
