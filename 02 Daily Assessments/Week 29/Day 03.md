...
type: assessment
schema_version: 1
id: assessment-w29-d03-delivery-pipelines-quality-and-security-scanning
date: null
week: 29
...
# Week 29 / Day 03 Micro-Assessment
...
1. Explain the key invariant, mechanism, or trade-off in **Compare local PHPStan/tests with SonarQube quality-gate concepts** without relying on tool/framework vocabulary alone.
2. What concrete evidence would validate or falsify your conclusion about **Compare local PHPStan/tests with SonarQube quality-gate concepts** in a production-oriented backend?
