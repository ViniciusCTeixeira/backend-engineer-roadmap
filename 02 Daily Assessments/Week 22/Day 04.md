...
type: assessment
schema_version: 1
id: assessment-w22-d04-docker-images-compose-and-runtime
date: null
week: 22
...
# Week 22 / Day 04 Micro-Assessment
...
1. Explain the key invariant, mechanism, or trade-off in **Use volumes and persistent-state boundaries correctly** without relying on tool/framework vocabulary alone.
2. What concrete evidence would validate or falsify your conclusion about **Use volumes and persistent-state boundaries correctly** in a production-oriented backend?
