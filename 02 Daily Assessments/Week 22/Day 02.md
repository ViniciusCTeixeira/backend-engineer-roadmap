...
type: assessment
schema_version: 1
id: assessment-w22-d02-docker-images-compose-and-runtime
date: null
week: 22
...
# Week 22 / Day 02 Micro-Assessment
...
1. Explain the key invariant, mechanism, or trade-off in **Separate build-time and runtime configuration** without relying on tool/framework vocabulary alone.
2. What concrete evidence would validate or falsify your conclusion about **Separate build-time and runtime configuration** in a production-oriented backend?
