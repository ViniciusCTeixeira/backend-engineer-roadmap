...
# Week 09 / Day 01 — V1.1 Micro-Assessment
...
1. Which relational invariants should be identical across both engines?
2. Name one schema decision that should not be copied mechanically between engines.
