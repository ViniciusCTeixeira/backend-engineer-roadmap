...
type: assessment
schema_version: 1
id: assessment-w09-d02-relational-modeling-and-sql
date: null
week: 9
...
# Week 09 / Day 02 Micro-Assessment
...
1. When is NULL semantically different from empty string/zero?
2. Give one rule for a DB constraint and one better kept in application/domain logic.
