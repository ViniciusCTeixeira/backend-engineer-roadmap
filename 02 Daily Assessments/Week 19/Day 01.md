...
type: assessment
schema_version: 1
id: assessment-w19-d01-laravel-application-security
date: null
week: 19
...
# Week 19 / Day 01 Micro-Assessment
...
1. Explain the key invariant, mechanism, or trade-off in **Separate authentication from authorization in Laravel** without relying on tool/framework vocabulary alone.
2. What concrete evidence would validate or falsify your conclusion about **Separate authentication from authorization in Laravel** in a production-oriented backend?
