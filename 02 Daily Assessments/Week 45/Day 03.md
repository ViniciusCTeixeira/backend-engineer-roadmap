...
type: assessment
schema_version: 1
id: assessment-w45-d03-algorithms-dynamic-programming-and-mixed-interviews
date: null
week: 45
...
# Week 45 / Day 03 Micro-Assessment
...
1. Explain the key invariant, mechanism, or trade-off in **Build a bottom-up table with space trade-offs** without relying on tool/framework vocabulary alone.
2. What concrete evidence would validate or falsify your conclusion about **Build a bottom-up table with space trade-offs** in a production-oriented backend?
