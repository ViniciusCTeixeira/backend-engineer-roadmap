...
type: assessment
schema_version: 1
id: assessment-w35-d02-reliability-outbox-saga-and-messaging-tradeoffs
date: null
week: 35
...
# Week 35 / Day 02 Micro-Assessment
...
1. Explain the key invariant, mechanism, or trade-off in **Design a transactional outbox flow and relay semantics** without relying on tool/framework vocabulary alone.
2. What concrete evidence would validate or falsify your conclusion about **Design a transactional outbox flow and relay semantics** in a production-oriented backend?
