...
type: assessment
schema_version: 1
id: assessment-w35-d05-reliability-outbox-saga-and-messaging-tradeoffs
date: null
week: 35
...
# Week 35 / Day 05 Micro-Assessment
...
1. Explain the key invariant, mechanism, or trade-off in **Compare SQS/RabbitMQ/Kafka against one workload** without relying on tool/framework vocabulary alone.
2. What concrete evidence would validate or falsify your conclusion about **Compare SQS/RabbitMQ/Kafka against one workload** in a production-oriented backend?
