...
type: assessment
schema_version: 1
id: assessment-w35-d01-reliability-outbox-saga-and-messaging-tradeoffs
date: null
week: 35
...
# Week 35 / Day 01 Micro-Assessment
...
1. Explain the key invariant, mechanism, or trade-off in **Derive the dual-write problem from a concrete workflow** without relying on tool/framework vocabulary alone.
2. What concrete evidence would validate or falsify your conclusion about **Derive the dual-write problem from a concrete workflow** in a production-oriented backend?
