...
type: daily-plan
schema_version: 1
id: task-w16-d03-php-testing-static-analysis-and-quality-loop
week: 16
day: 3
date: null
track: core
...
deliverables:
- test seam design
- overmocking diagnosis
- Project testability improvement
...
# Day 03 — Use Test Doubles at Real Boundaries, Not Everywhere

## Outcome

> Design the smallest seam for external/database dependencies and refactor one overmocked synthetic test.
...
Study the relevant primary source specifically for: Design the smallest seam for external/database dependencies and refactor one overmocked synthetic test.
...
Run `02 Daily Assessments/Week 16/Day 03.md`. Store learner attempts privately.
