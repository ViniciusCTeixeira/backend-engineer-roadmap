...
type: daily-plan
schema_version: 1
id: task-w37-d02-llm-tool-calling-and-bounded-actions
week: 37
day: 2
date: null
track: core
...
deliverables:
- Validate tool arguments and reject unauthorized resource access evidence
...
# Day 02 — Validate tool arguments and reject unauthorized resource access
...
Read the relevant primary source with the specific question: Validate tool arguments and reject unauthorized resource access.

### Hands-on reasoning / lab — 40 min — `SOLO`

Validate tool arguments and reject unauthorized resource access. Start with a prediction/design before execution or lookup.

### Project / evidence update — 15 min — `SOLO`

Connect the result to `platform-ai-tools` or preserve a reproducible standalone artifact.
...
Run `02 Daily Assessments/Week 37/Day 02.md`. Store learner responses only in private state.
