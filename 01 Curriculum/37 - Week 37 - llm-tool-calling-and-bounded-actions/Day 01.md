...
# Day 01 — Design Narrow Tool Schemas From Business Actions

## Outcome

> Define allowed actions/arguments and explicitly exclude broad database/shell/tool authority.
...
Run `02 Daily Assessments/Week 37/Day 01.md`. Store attempts privately.
