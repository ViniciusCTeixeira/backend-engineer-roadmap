...
type: daily-plan
schema_version: 1
id: task-w37-d03-llm-tool-calling-and-bounded-actions
week: 37
day: 3
date: null
track: core
...
- openai-developers
deliverables:
- Separate model proposal from application execution evidence
...
# Day 03 — Separate model proposal from application execution
...
Read the relevant primary source with the specific question: Separate model proposal from application execution.

### Hands-on reasoning / lab — 40 min — `SOLO`

Separate model proposal from application execution. Start with a prediction/design before execution or lookup.
...
Run `02 Daily Assessments/Week 37/Day 03.md`. Store learner responses only in private state.
