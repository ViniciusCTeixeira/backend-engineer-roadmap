...
> Implement a loop/state machine where the application decides whether/when the proposed tool call executes.
...
Run `02 Daily Assessments/Week 37/Day 03.md`. Store attempts privately.
