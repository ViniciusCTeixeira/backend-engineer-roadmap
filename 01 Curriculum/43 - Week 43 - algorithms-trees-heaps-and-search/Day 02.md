...
type: daily-plan
schema_version: 1
id: task-w43-d02-algorithms-trees-heaps-and-search
week: 43
day: 2
date: null
track: core
...
- mit-ocw-algorithms
deliverables:
- Use heap/priority-queue trade-offs for top-k/scheduling evidence
- Week 43 private assessment attempt
...
# Day 02 — Use heap/priority-queue trade-offs for top-k/scheduling

## Why this matters

Reason about tree traversal, heaps, binary search invariants, and ordered search without hiding behind library calls.
...
Read the relevant primary source with the specific question: Use heap/priority-queue trade-offs for top-k/scheduling.

### Hands-on reasoning / lab — 40 min — `SOLO`

Use heap/priority-queue trade-offs for top-k/scheduling. Start with a prediction/design before execution or lookup.
...
Explain a binary-search or tree invariant in English.
...
Run `02 Daily Assessments/Week 43/Day 02.md`. Store learner responses only in private state.
