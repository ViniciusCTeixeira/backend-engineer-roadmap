...
type: daily-plan
schema_version: 1
id: task-w43-d04-algorithms-trees-heaps-and-search
week: 43
day: 4
date: null
track: core
...
- mit-ocw-algorithms
deliverables:
- Compare BST/search assumptions with hash structures evidence
...
# Day 04 — Compare BST/search assumptions with hash structures
...
Read the relevant primary source with the specific question: Compare BST/search assumptions with hash structures.

### Hands-on reasoning / lab — 40 min — `SOLO`

Compare BST/search assumptions with hash structures. Start with a prediction/design before execution or lookup.
...
Run `02 Daily Assessments/Week 43/Day 04.md`. Store learner responses only in private state.
