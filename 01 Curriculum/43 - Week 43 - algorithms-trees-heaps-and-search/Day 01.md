...
type: daily-plan
schema_version: 1
id: task-w43-d01-algorithms-trees-heaps-and-search
week: 43
day: 1
date: null
track: core
...
- mit-ocw-algorithms
deliverables:
- Traverse trees with explicit base/invariant reasoning evidence
...
# Day 01 — Traverse trees with explicit base/invariant reasoning
...
Read the relevant primary source with the specific question: Traverse trees with explicit base/invariant reasoning.

### Hands-on reasoning / lab — 40 min — `SOLO`

Traverse trees with explicit base/invariant reasoning. Start with a prediction/design before execution or lookup.
...
Run `02 Daily Assessments/Week 43/Day 01.md`. Store learner responses only in private state.
