...
type: daily-plan
schema_version: 1
id: task-w43-d06-algorithms-trees-heaps-and-search
week: 43
day: 6
date: null
track: core
...
Run `03 Weekly Simulations/Week 43.md`; preserve any required pre-agent SOLO evidence.
...
Run `02 Daily Assessments/Week 43/Day 06.md`. Store learner responses only in private state.
