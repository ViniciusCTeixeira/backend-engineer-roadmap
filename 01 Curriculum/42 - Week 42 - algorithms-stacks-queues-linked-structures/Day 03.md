...
type: daily-plan
schema_version: 1
id: task-w42-d03-algorithms-stacks-queues-linked-structures
week: 42
day: 3
date: null
track: core
...
- mit-ocw-algorithms
deliverables:
- Solve linked-list pointer/invariant problems evidence
...
# Day 03 — Solve linked-list pointer/invariant problems
...
Read the relevant primary source with the specific question: Solve linked-list pointer/invariant problems.

### Hands-on reasoning / lab — 40 min — `SOLO`

Solve linked-list pointer/invariant problems. Start with a prediction/design before execution or lookup.
...
Run `02 Daily Assessments/Week 42/Day 03.md`. Store learner responses only in private state.
