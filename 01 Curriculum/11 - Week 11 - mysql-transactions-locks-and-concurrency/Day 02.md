...
# Day 02 — Compare MVCC and Isolation Mental Models

## Outcome

> Predict repeated reads and concurrent writes, then verify the configured isolation level and observed behavior in both engines.
