...
type: daily-plan
schema_version: 1
id: task-w11-d04-mysql-transactions-locks-and-concurrency
week: 11
day: 4
date: null
track: core
...
# Day 04 — Reproduce and Diagnose a Deadlock

## Outcome

> Design opposite lock order, predict timeline, reproduce safely, capture evidence, and propose mitigation/retry behavior.
...
Study the relevant primary source specifically for: Design opposite lock order, predict timeline, reproduce safely, capture evidence, and propose mitigation/retry behavior.
