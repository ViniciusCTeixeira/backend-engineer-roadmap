...
# Day 05 — Closed AWS IAM/VPC Design Case

## Outcome

> Design identity/network/data placement for the mixed backend and explain least privilege and public/private paths.
...
Run `02 Daily Assessments/Week 26/Day 05.md`. Store attempts privately.
