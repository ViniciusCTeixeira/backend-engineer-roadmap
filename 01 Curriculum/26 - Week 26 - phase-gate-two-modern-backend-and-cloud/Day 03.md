...
# Day 03 — Closed Docker/Nginx Troubleshooting Lab

## Outcome

> Diagnose a production-like Laravel/PostgreSQL/Redis request failure from process/network/log evidence.
...
Run `02 Daily Assessments/Week 26/Day 03.md`. Store attempts privately.
