...
# Day 04 — Closed Python/FastAPI and Contract Practical

## Outcome

> Read/modify a bounded FastAPI endpoint/test and reason about REST-vs-gRPC contract behavior without agent help.
...
Run `02 Daily Assessments/Week 26/Day 04.md`. Store attempts privately.
