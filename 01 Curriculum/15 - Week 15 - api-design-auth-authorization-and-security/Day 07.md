...
type: daily-plan
schema_version: 1
id: task-w15-d07-api-design-auth-authorization-and-security
week: 15
day: 7
date: null
track: core
...
# Day 07 — Review API Security and Finalize First Resume/GitHub Cleanup

## Outcome

> Run reviews, finalize first role-targeted resume draft, and audit public profile/repo descriptions.
...
Run `02 Daily Assessments/Week 15/Day 07.md`. Store learner attempts privately.
