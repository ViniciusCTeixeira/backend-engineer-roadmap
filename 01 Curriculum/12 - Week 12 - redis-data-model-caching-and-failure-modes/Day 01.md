...
type: daily-plan
schema_version: 1
id: task-w12-d01-redis-data-model-caching-and-failure-modes
week: 12
day: 1
date: null
track: core
...
- redis-data-types
deliverables:
- Redis structure decision table
- trade-off notes
- project Redis candidate
...
# Day 01 — Choose Redis Data Types by Required Operations

## Outcome

> Choose structures for counters, dedup, leaderboard, sessions and queue-like scenarios from required operations.
...
Study the relevant primary source specifically for: Choose structures for counters, dedup, leaderboard, sessions and queue-like scenarios from required operations.
...
Run `02 Daily Assessments/Week 12/Day 01.md`. Store learner attempts privately.
