...
deliverables:
- dual-engine schema/query attempt
- engine-difference explanation
...
# Day 03 — Closed MySQL/PostgreSQL Modeling and Query Case

## Outcome

> Model one domain then write equivalent SQL and explain one engine-specific difference without using an ORM.
...
Run `02 Daily Assessments/Week 13/Day 03.md`. Store learner attempts privately.
