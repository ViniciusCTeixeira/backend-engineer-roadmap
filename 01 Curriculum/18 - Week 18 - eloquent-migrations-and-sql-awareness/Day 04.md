...
type: daily-plan
schema_version: 1
id: task-w18-d04-eloquent-migrations-and-sql-awareness
week: 18
day: 4
date: null
track: core
...
deliverables:
- Use scopes/queries without hiding SQL costs evidence
...
# Day 04 — Use scopes/queries without hiding SQL costs
...
Read the relevant primary source with the specific question: Use scopes/queries without hiding SQL costs.

### Hands-on reasoning / lab — 40 min — `SOLO`

Use scopes/queries without hiding SQL costs. Start with a prediction/design before execution or lookup.

### Project / evidence update — 15 min — `SOLO`

Connect the result to `platform-persistence` or preserve a reproducible standalone artifact.
...
Run `02 Daily Assessments/Week 18/Day 04.md`. Store learner responses only in private state.
