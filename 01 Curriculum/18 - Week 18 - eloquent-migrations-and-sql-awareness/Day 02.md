...
# Day 02 — Map Eloquent Relationships to Cardinality

## Outcome

> Implement relationships and verify generated foreign keys/queries against the relational model.
...
Run `02 Daily Assessments/Week 18/Day 02.md`. Store learner attempts privately.
