...
# Day 05 — Run the Stack From a Clean Local State

## Outcome

> Rebuild/recreate the stack and prove migrations/health/dependency behavior without undocumented machine state.
...
Run `02 Daily Assessments/Week 22/Day 05.md`. Store learner attempts privately.
