...
type: daily-plan
schema_version: 1
id: task-w44-d02-algorithms-graphs-bfs-dfs-and-shortest-paths
week: 44
day: 2
date: null
track: core
...
- mit-ocw-algorithms
deliverables:
- Solve BFS shortest-unweighted and level problems evidence
- Week 44 private assessment attempt
...
# Day 02 — Solve BFS shortest-unweighted and level problems

## Why this matters

Model graph problems explicitly and choose BFS/DFS/topological/shortest-path approaches from constraints and edge properties.
...
Read the relevant primary source with the specific question: Solve BFS shortest-unweighted and level problems.

### Hands-on reasoning / lab — 40 min — `SOLO`

Solve BFS shortest-unweighted and level problems. Start with a prediction/design before execution or lookup.
...
Explain why a graph traversal is correct for one backend-like dependency problem.
...
Run `02 Daily Assessments/Week 44/Day 02.md`. Store learner responses only in private state.
