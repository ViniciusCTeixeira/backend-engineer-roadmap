...
type: daily-plan
schema_version: 1
id: task-w44-d03-algorithms-graphs-bfs-dfs-and-shortest-paths
week: 44
day: 3
date: null
track: core
...
- mit-ocw-algorithms
deliverables:
- Solve DFS connectivity/cycle problems evidence
...
# Day 03 — Solve DFS connectivity/cycle problems
...
Read the relevant primary source with the specific question: Solve DFS connectivity/cycle problems.

### Hands-on reasoning / lab — 40 min — `SOLO`

Solve DFS connectivity/cycle problems. Start with a prediction/design before execution or lookup.
...
Run `02 Daily Assessments/Week 44/Day 03.md`. Store learner responses only in private state.
