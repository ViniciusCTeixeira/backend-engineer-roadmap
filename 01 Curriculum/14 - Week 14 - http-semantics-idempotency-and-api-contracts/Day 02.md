...
type: daily-plan
schema_version: 1
id: task-w14-d02-http-semantics-idempotency-and-api-contracts
week: 14
day: 2
date: null
track: core
...
# Day 02 — Use Methods, Status Codes, Headers, and Representations Semantically

## Outcome

> Choose method/status/header semantics for concrete operations and document one Project B endpoint.
...
Study the relevant primary source specifically for: Choose method/status/header semantics for concrete operations and document one Project B endpoint.
...
Run `02 Daily Assessments/Week 14/Day 02.md`. Store learner attempts privately.
