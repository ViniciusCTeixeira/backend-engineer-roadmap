...
deliverables:
- REST semantics matrix
- Project B contract slice
...
# Day 02 — Design REST Methods, Status, Headers, and Representations

## Outcome

> Choose semantics for concrete API operations and preserve useful error/representation behavior.
