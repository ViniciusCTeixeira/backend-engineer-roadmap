...
type: daily-plan
schema_version: 1
id: task-w47-d02-evidence-driven-remediation-and-gap-closure
week: 47
day: 2
date: null
track: core
...
[]
deliverables:
- Prioritize prerequisite gaps by dependency and recurrence evidence
...
# Day 02 — Prioritize prerequisite gaps by dependency and recurrence
...
Read the relevant primary source with the specific question: Prioritize prerequisite gaps by dependency and recurrence.

### Hands-on reasoning / lab — 40 min — `SOLO`

Prioritize prerequisite gaps by dependency and recurrence. Start with a prediction/design before execution or lookup.
...
Run `02 Daily Assessments/Week 47/Day 02.md`. Store learner responses only in private state.
