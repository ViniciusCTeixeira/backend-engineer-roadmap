...
type: daily-plan
schema_version: 1
id: task-w47-d03-evidence-driven-remediation-and-gap-closure
week: 47
day: 3
date: null
track: core
...
[]
deliverables:
- Run SOLO reconstruction on the highest-risk conceptual gap evidence
- Week 47 private assessment attempt
...
# Day 03 — Run SOLO reconstruction on the highest-risk conceptual gap

## Why this matters

Turn Gate/interview/application evidence into prioritized remediation while preserving historical attempts and protecting the weekly workload ceiling.
...
Read the relevant primary source with the specific question: Run SOLO reconstruction on the highest-risk conceptual gap.

### Hands-on reasoning / lab — 40 min — `SOLO`

Run SOLO reconstruction on the highest-risk conceptual gap. Start with a prediction/design before execution or lookup.
...
Explain one remediation decision from evidence in English.
...
Run `02 Daily Assessments/Week 47/Day 03.md`. Store learner responses only in private state.
