...
type: daily-plan
schema_version: 1
id: task-w50-d06-full-senior-backend-interview-loop
week: 50
day: 6
date: null
track: core
...
Run `03 Weekly Simulations/Week 50.md`; preserve any required pre-agent SOLO evidence.
...
Run `02 Daily Assessments/Week 50/Day 06.md`. Store learner responses only in private state.
