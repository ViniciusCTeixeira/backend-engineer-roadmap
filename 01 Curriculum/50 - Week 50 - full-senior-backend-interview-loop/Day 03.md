...
type: daily-plan
schema_version: 1
id: task-w50-d03-full-senior-backend-interview-loop
week: 50
day: 3
date: null
track: core
...
Read the relevant primary source with the specific question: System-design round.

### Hands-on reasoning / lab — 40 min — `SOLO`

System-design round. Start with a prediction/design before execution or lookup.
...
Run `02 Daily Assessments/Week 50/Day 03.md`. Store learner responses only in private state.
