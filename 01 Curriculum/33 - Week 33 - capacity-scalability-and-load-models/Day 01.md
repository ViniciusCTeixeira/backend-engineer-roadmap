...
# Day 01 — Translate Product Traffic Into Load Assumptions

## Outcome

> Estimate requests, concurrency, payload, background work, and peak factors with explicit units and uncertainty.
...
Run `02 Daily Assessments/Week 33/Day 01.md`. Store attempts privately.
