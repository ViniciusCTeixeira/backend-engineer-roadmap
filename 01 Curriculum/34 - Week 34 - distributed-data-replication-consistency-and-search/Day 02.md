...
# Day 02 — Choose Embedding vs References and Add Validation

## Outcome

> Model relationship cardinality/update frequency/document growth and define schema validation where useful.
...
Run `02 Daily Assessments/Week 34/Day 02.md`. Store attempts privately.
