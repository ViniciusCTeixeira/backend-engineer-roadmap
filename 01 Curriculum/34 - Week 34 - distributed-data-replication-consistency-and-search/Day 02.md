...
type: daily-plan
schema_version: 1
id: task-w34-d02-distributed-data-replication-consistency-and-search
week: 34
day: 2
date: null
track: core
...
- builders-library
deliverables:
- Reason about partition keys and hotspot risks evidence
...
# Day 02 — Reason about partition keys and hotspot risks
...
Read the relevant primary source with the specific question: Reason about partition keys and hotspot risks.

### Hands-on reasoning / lab — 40 min — `SOLO`

Reason about partition keys and hotspot risks. Start with a prediction/design before execution or lookup.
...
Run `02 Daily Assessments/Week 34/Day 02.md`. Store learner responses only in private state.
