...
type: daily-plan
schema_version: 1
id: task-w30-d02-observability-otel-metrics-traces-and-errors
week: 30
day: 2
date: null
track: core
...
- grafana-get-started
deliverables:
- Choose useful metrics and labels for service questions evidence
...
# Day 02 — Choose useful metrics and labels for service questions
...
Read the relevant primary source with the specific question: Choose useful metrics and labels for service questions.

### Hands-on reasoning / lab — 40 min — `SOLO`

Choose useful metrics and labels for service questions. Start with a prediction/design before execution or lookup.
...
Run `02 Daily Assessments/Week 30/Day 02.md`. Store learner responses only in private state.
