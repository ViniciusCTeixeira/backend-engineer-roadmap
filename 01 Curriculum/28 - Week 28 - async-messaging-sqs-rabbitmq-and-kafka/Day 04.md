...
type: daily-plan
schema_version: 1
id: task-w28-d04-async-messaging-sqs-rabbitmq-and-kafka
week: 28
day: 4
date: null
track: core
...
- rabbitmq-tutorials
deliverables:
- Run bounded RabbitMQ comparison lab evidence
...
# Day 04 — Run bounded RabbitMQ comparison lab
...
Read the relevant primary source with the specific question: Run bounded RabbitMQ comparison lab.

### Hands-on reasoning / lab — 40 min — `SOLO`

Run bounded RabbitMQ comparison lab. Start with a prediction/design before execution or lookup.
...
Run `02 Daily Assessments/Week 28/Day 04.md`. Store learner responses only in private state.
