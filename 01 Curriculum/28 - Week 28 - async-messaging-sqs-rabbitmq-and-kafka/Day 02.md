...
type: daily-plan
schema_version: 1
id: task-w28-d02-async-messaging-sqs-rabbitmq-and-kafka
week: 28
day: 2
date: null
track: core
...
- kafka-quickstart
deliverables:
- Design retries/backoff/visibility/dead-letter behavior evidence
- Week 28 private assessment attempt
- `platform-async` increment or review
...
# Day 02 — Design retries/backoff/visibility/dead-letter behavior
...
Read the relevant primary source with the specific question: Design retries/backoff/visibility/dead-letter behavior.

### Hands-on reasoning / lab — 40 min — `SOLO`

Design retries/backoff/visibility/dead-letter behavior. Start with a prediction/design before execution or lookup.

### Project / evidence update — 15 min — `SOLO`

Connect the result to `platform-async` or preserve a reproducible standalone artifact.

### Technical English — 10 min — `SOLO`

Explain at-least-once delivery and idempotent consumers in English.
...
Run `02 Daily Assessments/Week 28/Day 02.md`. Store learner responses only in private state.
