...
# Day 04 — Observe Rollouts, Logs, and Events

## Outcome

> Trigger/inspect a rolling update and diagnose a bad image/config/probe using kubectl-visible evidence.
...
Run `02 Daily Assessments/Week 32/Day 04.md`. Store attempts privately.
