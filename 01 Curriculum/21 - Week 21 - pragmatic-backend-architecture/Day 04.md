...
type: daily-plan
schema_version: 1
id: task-w21-d04-pragmatic-backend-architecture
week: 21
day: 4
date: null
track: core
...
deliverables:
- Make dependency direction explicit evidence
...
# Day 04 — Make dependency direction explicit
...
Read the relevant primary source with the specific question: Make dependency direction explicit.

### Hands-on reasoning / lab — 40 min — `SOLO`

Make dependency direction explicit. Start with a prediction/design before execution or lookup.
...
Run `02 Daily Assessments/Week 21/Day 04.md`. Store learner responses only in private state.
