...
- builders-library
deliverables:
- service-boundary rubric
- Python candidate evaluation
...
# Day 04 — Define a Modular-Monolith vs Service Boundary Rubric

## Outcome

> Evaluate deployability, data ownership, failure isolation, latency, team ownership, and operational cost before proposing a service.
...
Run `02 Daily Assessments/Week 21/Day 04.md`. Store learner attempts privately.
