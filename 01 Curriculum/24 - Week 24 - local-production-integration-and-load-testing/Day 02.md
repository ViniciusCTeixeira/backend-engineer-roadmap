...
type: daily-plan
schema_version: 1
id: task-w24-d02-local-production-integration-and-load-testing
week: 24
day: 2
date: null
track: core
...
- k6-get-started
deliverables:
- Create readiness/health and dependency-failure checks evidence
...
# Day 02 — Create readiness/health and dependency-failure checks
...
Read the relevant primary source with the specific question: Create readiness/health and dependency-failure checks.

### Hands-on reasoning / lab — 40 min — `SOLO`

Create readiness/health and dependency-failure checks. Start with a prediction/design before execution or lookup.
...
Run `02 Daily Assessments/Week 24/Day 02.md`. Store learner responses only in private state.
