...
# Day 01 — Model Desired State and Plan/Apply Lifecycle

## Outcome

> Create a bounded Terraform configuration and explain provider state versus live infrastructure.
...
Run `02 Daily Assessments/Week 31/Day 01.md`. Store attempts privately.
