...
type: daily-plan
schema_version: 1
id: task-w45-d02-algorithms-dynamic-programming-and-mixed-interviews
week: 45
day: 2
date: null
track: core
...
- mit-ocw-algorithms
deliverables:
- Convert recursive recurrence to memoization evidence
...
# Day 02 — Convert recursive recurrence to memoization
...
Read the relevant primary source with the specific question: Convert recursive recurrence to memoization.

### Hands-on reasoning / lab — 40 min — `SOLO`

Convert recursive recurrence to memoization. Start with a prediction/design before execution or lookup.
...
Run `02 Daily Assessments/Week 45/Day 02.md`. Store learner responses only in private state.
