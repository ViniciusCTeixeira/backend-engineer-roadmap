...
type: daily-plan
schema_version: 1
id: task-w45-d04-algorithms-dynamic-programming-and-mixed-interviews
week: 45
day: 4
date: null
track: core
...
- mit-ocw-algorithms
deliverables:
- Solve one string/sequence DP problem evidence
...
# Day 04 — Solve one string/sequence DP problem
...
Read the relevant primary source with the specific question: Solve one string/sequence DP problem.

### Hands-on reasoning / lab — 40 min — `SOLO`

Solve one string/sequence DP problem. Start with a prediction/design before execution or lookup.
...
Run `02 Daily Assessments/Week 45/Day 04.md`. Store learner responses only in private state.
