...
# Day 03 — Correlate Access, Error, FPM, and Application Logs

## Outcome

> Use request IDs/timestamps where possible and diagnose a synthetic 5xx without random config edits.
...
Run `02 Daily Assessments/Week 23/Day 03.md`. Store learner attempts privately.
