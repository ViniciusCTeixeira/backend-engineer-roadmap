...
type: daily-plan
schema_version: 1
id: task-w23-d04-nginx-php-fpm-production-path
week: 23
day: 4
date: null
track: core
...
deliverables:
- Correlate access/error/FPM logs evidence
...
# Day 04 — Correlate access/error/FPM logs
...
Read the relevant primary source with the specific question: Correlate access/error/FPM logs.

### Hands-on reasoning / lab — 40 min — `SOLO`

Correlate access/error/FPM logs. Start with a prediction/design before execution or lookup.
...
Run `02 Daily Assessments/Week 23/Day 04.md`. Store learner responses only in private state.
