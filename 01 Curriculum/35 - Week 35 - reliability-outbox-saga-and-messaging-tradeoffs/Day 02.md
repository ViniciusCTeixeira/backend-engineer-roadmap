...
type: daily-plan
schema_version: 1
id: task-w35-d02-reliability-outbox-saga-and-messaging-tradeoffs
week: 35
day: 2
date: null
track: core
...
- rabbitmq-tutorials
deliverables:
- Design a transactional outbox flow and relay semantics evidence
...
# Day 02 — Design a transactional outbox flow and relay semantics
...
Read the relevant primary source with the specific question: Design a transactional outbox flow and relay semantics.

### Hands-on reasoning / lab — 40 min — `SOLO`

Design a transactional outbox flow and relay semantics. Start with a prediction/design before execution or lookup.
...
Run `02 Daily Assessments/Week 35/Day 02.md`. Store learner responses only in private state.
